...
export default function ResidentialSystems() {
  ...
  const handleFilterChange = (newFilters: typeof filters) => {
    // Keep category locked to residential
    setFilters({ ...newFilters, category: "residential" });
  ...
  // Filter products to only residential category
  const filteredProducts = useMemo(() => {
    let result = products.filter((p) => p.category === "residential");
      ...
      <div className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white h-[375px] flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg md:text-xl text-blue-50 max-w-3xl">
            Power your home with reliable, efficient battery storage solutions
              ...
              {filteredProducts.length === 0 && (
                <div className="text-center py-16">
                  <p className="text-gray-500 text-lg">
                    No residential products found matching your filters.
                  </p>

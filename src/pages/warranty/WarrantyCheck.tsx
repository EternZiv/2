      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex gap-3">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent text-lg"
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-4">
            <Link to="/warranty-registration" className="block p-6 bg-blue-50 border border-blue-200 rounded-lg hover:shadow-md transition">

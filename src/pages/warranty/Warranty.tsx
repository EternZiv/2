            ...
            {claimProcess.map((step, index) => (
              <div key={index} className="relative">
                ...
                {index < claimProcess.length - 1 && (
                  <div className="hidden md:block absolute top-1/2 -right-3 w-6 h-0.5 bg-blue-300 z-10" />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto mb-8">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6">
              ...
              <div className="text-blue-100">Karachi: 111-P2G-247</div>
              <div className="text-blue-100">Lahore: (042) 3591 1165-69</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6">
              <Mail className="w-8 h-8 mx-auto mb-3" />
              <div className="font-semibold mb-2">Email Support</div>
              <div className="text-blue-100">warranty@power2go.energy</div>
              <div className="text-blue-100">support@power2go.energy</div>
            </div>
          </div>

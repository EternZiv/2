...
export default function WarrantyCard() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative h-[400px] bg-gradient-to-br from-blue-600 to-cyan-600 text-white print:hidden">
      ...
      {showCard && (
        <section className="py-16 md:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            `}</style>
            <div id="warranty-card" className="bg-white border-4 border-blue-600 rounded-lg shadow-2xl overflow-hidden">
              {/* Header */}
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100">5-Year Comprehensive Coverage</p>
                    </div>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="text-xl font-bold text-blue-600">{warrantyData.warrantyNumber}</div>
                    </div>
                    <div>

            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="mt-4">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent resize-none"
              ...
              <div className="flex gap-4">
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white py-6 text-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >

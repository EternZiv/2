...
// Wrapper for icons to filter out Figma props
const SafeIcon = ({ Icon, ...props }: { Icon: React.ComponentType<any>, [key: string]: any }) => {
  return <Icon {...filterFigmaProps(props)} />;
};
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <SafeIcon Icon={ChevronDownIcon} className="size-4 opacity-50" />
    ...
    >
      <span className="absolute right-2 flex size-3.5 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <SafeIcon Icon={CheckIcon} className="size-4" />
        </SelectPrimitive.ItemIndicator>
      </span>
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...filterFigmaProps(props)}
    >
      <SafeIcon Icon={ChevronUpIcon} className="size-4" />
    </SelectPrimitive.ScrollUpButton>
  );
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...filterFigmaProps(props)}
    >
      <SafeIcon Icon={ChevronDownIcon} className="size-4" />
    </SelectPrimitive.ScrollDownButton>
  );
}
